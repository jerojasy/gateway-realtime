...
@app.route('/conf_num_destino')
def conf_num_destino():
    return render_template('conf_num_destino.html')

@app.route('/conf_numero_origen')
def conf_numero_origen():
    return render_template('conf_numero_origen.html')
...
def mensajeria():
    ...
    if request.method == 'POST':
        ...
        if response.status_code == 200:
            return render_template('mensajeria.html', msg="Mensaje Enviado a: "+number, flag='success')
        else:
            return render_template('mensajeria.html', msg="No se ha podido envíar el mensaje a: "+number, flag='danger')
